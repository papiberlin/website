        ...
        <header>
          ...
          <div class="head">
            <div class="description">
              <p><xsl:value-of select="atom:link/@href"/></p>
              <p><a hreflang="en"><xsl:attribute name="href"><xsl:value-of select="atom:link[@rel='alternate']/@href"/></xsl:attribute>Visit Website &#x2192;</a></p>
            </div>
          </div>
        </header>
        <main>
          ...
          <xsl:for-each select="atom:entry">
            <article>
              <h3><a hreflang="en" target="_blank"><xsl:attribute name="href"><xsl:value-of select="atom:link/@href"/></xsl:attribute><xsl:value-of select="atom:title"/></a></h3>
              <footer>Published: <time><xsl:value-of select="atom:updated" /></time></footer>
            </article>
          </xsl:for-each>
          <p class="about"><img src="/favicon.ico" alt="papi berlin icon" width="24" height="24" /><a href="https://papiberlin.de/about">About Papi Berlin</a>.</p>
        </main>
      </body>
    </html>
  </xsl:template>
